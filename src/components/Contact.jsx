    ...
    <section id="contact" className="px-6 py-24">
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mb-10 text-gray-400">
          Have a technical challenge or MVP concept? I'm available for
          consulting engagements and contract development work.
        </p>

        <div className="rounded-2xl border border-dark-700 bg-dark-900/50 p-8">
