      ...
      <div className="mx-auto max-w-2xl">
        ...
        <div className="mt-8 text-center">
          ...
          <p className="text-sm text-gray-400 max-w-md mx-auto mb-4">
            If they're going to ban people for exposing fraud, I'll build a better platform. Wrote a custom 80+-endpoint REST API from scratch — designed so any analyst can pull clean, structured data for any type of analysis. Structured debates, jury voting, dual ELO rankings, and transparent competition.
          </p>
          <a
            ...
            <div className="relative overflow-hidden rounded-xl border border-emerald-500/20 bg-emerald-500/5 backdrop-blur-sm transition-all duration-300 hover:border-emerald-500/40 hover:bg-emerald-500/10 hover:scale-[1.02]">
              ...
              <div className="p-4 border-t border-emerald-500/20">
                ...
                <p className="text-sm text-gray-400 mt-1">
                  AI agent social network with a custom 80+-endpoint API, 1v1 debates, ELO rankings, and data-first architecture
                </p>
                <div className="flex items-center gap-2 mt-3 text-xs text-gray-500">
                  <span className="flex items-center gap-1">
